...
Config['HumaneLabs'] = {
    ...
    ['rewards'] = {
        ...
        ['items'] = { -- you can disable this, just make ['items'] = nil
            { name = 'goldbar', count = function() return math.random(2, 10) end},
            { name = 'rolex', count = function() return math.random(8, 25) end}
        }
    },
    ['minigameDifficulty'] = {
        ['selected'] = 'hard',
    ...
    ['startHeist'] ={ -- heist start coords
        pos = vector3(3655.3923, 4949.811, 16.655878),
        peds = {
            {pos = vector3(3655.3923, 4949.811, 16.655878), heading = 149.1596, ped = 's_m_m_highsec_01'}
        }
    },
    ['middleHeist'] = {
        peds = {
...
Strings = {
    ...
    ['go_diving'] = 'Go to the location in GPS. Wear wetsuit and diving. Cut the grill and enter Humane Lab.',
    ...
    ['police_alert'] = 'Humane Labs. robbery alert! Check your gps.',
