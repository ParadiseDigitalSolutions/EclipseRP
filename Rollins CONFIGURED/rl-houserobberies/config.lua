Config = {}
Config.Framework = 'OTHER' -- Available Frameworks: 'ESX', 'QBCORE', 'VRP' (by dunko), 'OTHER'.
Config.CoordsWait = math.random(1,3) -- Time before you receive the house coords (1 - 2 minutes).
...
Config.RandomPoliceCall = false -- Small chance to call cops when players uses the lockpick on door.
...
Config.CdTime = 15 -- 1 = 30 minutes, 2 = 60 minutes, 3 = 90 minutes.... Personal cooldown time for players before they can rob another house.
...
Config.SafeRewards = { -- It will pick a random combination from this table. type = 'item' or 'cash'
	[1] = {
		{type = 'item', itemName = 'goldbar', itemQty = math.random(1,2)},
	},
	[2] = {
		{type = 'item', itemName = 'markedbills', itemQty = math.random(3,20)},
	},
	[3] = {
		{type = 'item', itemName = 'rolex', itemQty = 2},
	}
}

Config.ItemsReward = { -- It will pick a random combination from this table.
	[1] = {
		{type = 'item', itemName = 'goldchain', itemQty = math.random(0,2)},
		{type = 'item', itemName = 'diamond_ring', itemQty = math.random(1,2)},
	},
...
AddEventHandler('rl_houserobbery:notification', function(msg)
	...
	TriggerClientEvent("QBCore:Notify", "Writing", "success", 2500)
