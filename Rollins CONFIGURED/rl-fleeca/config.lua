...
Fleeca.maxcash = 8500 -- maximum amount of cash a pile can hold
Fleeca.mincash = 4000 -- minimum amount of cash a pile holds
Fleeca.cooldown = 1800 -- amount of time to do the heist again in seconds (15min)
Fleeca.mincops = 4 -- minimum required cops to start mission
