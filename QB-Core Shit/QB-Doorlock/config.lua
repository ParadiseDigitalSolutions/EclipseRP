...
Config.DoorList = {
	...
	},
	{
		...
		doors = {
...

			{
				objName = 'gabz_mrpd_door_03',
				objYaw = 360.0,
				objCoords = vector3(467.7743, -1014.406, 26.48697)
			}
		}
	},
	{
		...
		doors = {
			{
				...
				objYaw = 340.0,
				objCoords = vector3(324, -589, 43),		
			},

			{
				objName = 'gabz_pillbox_doubledoor_r',
				objYaw = 340.0,
				objCoords = vector3(326, -590, 43),	
			}
		}
	},	
	{
		...
		doors = {
			{
				objName = 'gabz_pillbox_doubledoor_r',
				objYaw = 340.0,
				objCoords = vector3(320, -574, 43),		
			},

			{
				objName = 'gabz_pillbox_doubledoor_l',
				objYaw = 340.0,
				objCoords = vector3(317, -573, 43),	
			}
		}
	},	
	{
		objName = "gabz_pillbox_singledoor",
		objCoords  = vector3(309.1337, -597.7515, 43.43),			
		textCoords = vector3(1136.689, -466.8952, 66.63),			
		authorizedJobs = { 'ambulance', 'police' },
		objYaw = 159.0,
		locking = false,
		locked = true,
	...
	{
		objName = "gabz_pillbox_singledoor",
		objCoords  = vector3(303.9596, -572.5579, 43.43),			
		textCoords = vector3(1136.689, -466.8952, 66.63),			
		authorizedJobs = { 'ambulance', 'police' },
		objYaw = 70.0,
		locking = false,
	...
	{
		objName = "gabz_pillbox_singledoor",
		objCoords  = vector3(307.1182, -569.569, 43.43),			
		textCoords = vector3(1136.689, -466.8952, 66.63),			
		authorizedJobs = { 'ambulance', 'police' },
		objYaw = 340.0,
		locking = false,
	...
	{
		objName = "gabz_pillbox_singledoor",
		objCoords  = vector3(339.005, -586.70, 43.43),			
		textCoords = vector3(1136.689, -466.8952, 66.63),			
		authorizedJobs = { 'ambulance', 'police' },
		objYaw = 340.0,
		locking = false,
	...
	{
		objName = "gabz_pillbox_singledoor",
		objCoords  = vector3(336.1628, -580.14, 43.43),			
		textCoords = vector3(1136.689, -466.8952, 66.63),			
		authorizedJobs = { 'ambulance', 'police' },
		objYaw = 340.0,
		locking = false,
	...
	{
		objName = "gabz_pillbox_singledoor",
		objCoords  = vector3(346.7739, -584.00, 43.43),			
		textCoords = vector3(1136.689, -466.8952, 66.63),			
		authorizedJobs = { 'ambulance', 'police' },
		objYaw = 340.0,
		locking = false,
	...
	{
		objName = "gabz_pillbox_singledoor",
		objCoords  = vector3(340.7818, -581.82, 43.43),			
		textCoords = vector3(1136.689, -466.8952, 66.63),			
		authorizedJobs = { 'ambulance', 'police' },
		objYaw = 340.0,
		locking = false,
		...
		doors = {
			{
				objName = 'gabz_pillbox_doubledoor_r',
				objYaw = 160.0,
				objCoords = vector3(316, -578, 43),		
			},

			{
				objName = 'gabz_pillbox_doubledoor_l',
				objYaw = 160.0,
				objCoords = vector3(318, -579, 43),	
			}
		}
	},	
	{
		...
		doors = {
			{
				objName = 'gabz_mrpd_reception_entrancedoor',
				objYaw = 180.0,
				objCoords = vector3(458.1802, -972.276, 30.709)
			},
	...
	{
		objName = 'np_prison_door_01',
		objCoords = vec3(1818.7658, 2594.3024, 45.969676), 
		textCoords = vec3(1818.7658, 2594.3024, 45.969676),
		authorizedJobs = { 'police' },
		locked = true,
		pickable = false,
		distance = 2
