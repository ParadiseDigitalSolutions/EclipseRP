Customize = {
    Framework = "QBCore", -- QBCore | ESX | NewESX | OldQBCore
    ...
    GetVehFuel = function(Veh)
        return exports["lc-fuel"]:GetFuel(Veh)
    end,
    ...
    DisableJobsStress = { 'police', 'ambulance' }, -- Add here jobs you want to disable stress
