...
Config.Strains = {
    ...
    ['amber_kush'] = {
        label = 'Amber Kush',
        seed = 'ls_amber_kush_seed',
        bud = 'ls_amber_kush_bud',
        bag = 'ls_amber_kush_bag',
        joint = 'ls_amber_kush_joint',
        level = 2,
        exp = { min = 10, max = 16 },
        yields = {
            buds = { min = 2, max = 4 },
    ...
    ['citrus_ember'] = {
        label = 'Citrus Ember',
        seed = 'ls_citrus_ember_seed',
        bud = 'ls_citrus_ember_bud',
        bag = 'ls_citrus_ember_bag',
        joint = 'ls_citrus_ember_joint',
        level = 3,
        exp = { min = 12, max = 20 },
        yields = {
            buds = { min = 3, max = 5 },
    ...
    ['golden_solstice'] = {
        label = 'Golden Solstice',
        seed = 'ls_golden_solstice_seed',
        bud = 'ls_golden_solstice_bud',
        bag = 'ls_golden_solstice_bag',
        joint = 'ls_golden_solstice_joint',
        level = 5,
        exp = { min = 20, max = 45 },
        yields = {
            buds = { min = 4, max = 10 },
    ...
    ['inferno_blaze'] = {
        label = 'Inferno Blaze',
        seed = 'ls_inferno_blaze_seed',
        bud = 'ls_inferno_blaze_bud',
        bag = 'ls_inferno_blaze_bag',
        joint = 'ls_inferno_blaze_joint',
        level = 7,
        exp = { min = 45, max = 65 },
        yields = {
            buds = { min = 5, max = 8 },
    ...
    ['aqua_bliss'] = {
        label = 'Aqua Bliss',
        seed = 'ls_aqua_bliss_seed',
        bud = 'ls_aqua_bliss_bud',
        bag = 'ls_aqua_bliss_bag',
        joint = 'ls_aqua_bliss_joint',
        level = 8,
        exp = { min = 65, max = 85 },
        yields = {
            buds = { min = 5, max = 8 },
    ...
    ['shadow_snow'] = {
        label = 'Shadow Snow',
        seed = 'ls_shadow_snow_seed',
        bud = 'ls_shadow_snow_bud',
        bag = 'ls_shadow_snow_bag',
        joint = 'ls_shadow_snow_joint',
        level = 9,
        exp = { min = 95, max = 125 },
        yields = {
            buds = { min = 7, max = 10 },
    ...
    ['midnight_frost'] = {
        ...
        seed = 'ls_midnight_frost_seed',
        bud = 'ls_midnight_frost_bud',
        bag = 'ls_midnight_frost_bag',
        joint = 'ls_midnight_frost_joint',
        level = 10,
        exp = { min = 190, max = 225 },
        yields = {
            buds = { min = 8, max = 11 },
    ...
    ['crimson_eclipse'] = {
        ...
        seed = 'ls_crimson_eclipse_seed',
        bud = 'ls_crimson_eclipse_bud',
        bag = 'ls_crimson_eclipse_bag',
        joint = 'ls_crimson_eclipse_joint',
        level = 10,
        exp = { min = 150, max = 250 },
        yields = {
            buds = { min = 6, max = 15 },
...
Config.Shop = {
    ...
    items = {
        ...
        [1] = { item = 'ls_watering_can', price = 25, label = 'Water', icon = 'droplet', min = 1, max = 1 },
        [2] = { item = 'ls_fertilizer', price = 25, label = 'Fertilizer', icon = 'burger', min = 1, max = 1 },
        [3] = { item = 'ls_plant_pot', price = 20, label = 'Plant Pot', icon = 'plant-wilt', min = 1, max = 1 },
        -- [4] = { item = 'ls_shovel', price = 275, label = 'Shovel', icon = 'trowel', min = 1, max = 1 },
        [4] = { item = 'ls_shears', price = 150, label = 'Shears', icon = 'scissors', min = 1, max = 1 },
        [5] = { item = 'ls_rolling_paper', price = 15, label = 'Rolling Paper', icon = 'joint', min = 1, max = 50 },
        [6] = { item = 'ls_empty_baggy', price = 5, label = 'Empty Baggy', icon = 'bag-shopping', min = 1, max = 50 },
        --[7] = { item = 'ls_weed_table', price = 5000, label = 'Weed Table', icon = 'cannabis', min = 1, max = 1 },
...
Config.Table = {
    ...
    buds = {
        ...
        ['og_kush'] = {
            ...
            duration = { rolling = 5000, bagging = 3500 },
        ...
        ['shadow_snow'] = {
            ...
            max_actions = { rolling = 15, bagging = 15 },
            exp = {
                rolling = { min = 20, max = 30 },
                bagging = { min = 7, max = 10 }
            },
            icon = 'fas fa-cannabis',
            iconColor = ''
        },
        ['midnight_frost'] = {
            ...
            max_actions = { rolling = 15, bagging = 15 },
            exp = {
                rolling = { min = 30, max = 50 },
                bagging = { min = 10, max = 20 }
            },
            icon = 'fas fa-cannabis',
            iconColor = ''
        },
...
Config.Joints = {
    ...
    ['ls_og_kush_joint'] = {
        ...
        effects = {
            ...
            -- duration: if enabled, how long (in milliseconds) to activate the effect
            screen = { enable = true, effect = 'stoned_monkeys', duration = 10000 },
            -- enable: do you want to enable this effect?
            ...
            -- duration: if enabled, how long (in milliseconds) to activate the effect
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 10000 },
            -- enable: do you want to enable this effect?
            ...
            -- duration: if enabled, how long (in milliseconds) to activate the effect
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 10000 }
        }
    },
    ['ls_amber_kush_joint'] = {
        usable = true,
        ...
        effects = {
            health = { enable = false, amount = 50 },
            armor = { enable = false, amount = 20, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 12500 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 12500 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 12500 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 12500 }
        }
    },
    ['ls_citrus_ember_joint'] = {
        usable = true,
        level = 1,
        effects = {
            health = { enable = false, amount = 50 },
            armor = { enable = false, amount = 20, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 15000 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 15000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 15000 }
        }
    },
    ['ls_blue_dream_joint'] = {
        usable = true,
        ...
        effects = {
            ...
            armor = { enable = false, amount = 20, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 17500 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 17500 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 17500 }
        }
    },
    ['ls_purple_haze_joint'] = {
        ...
        level = 1,
        effects = {
            health = { enable = true, amount = 10 },
            armor = { enable = false, amount = 20, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 20000 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 20000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 20000 }
        }
    },
    ['ls_golden_solstice_joint'] = {
        usable = true,
        level = 1,
        effects = {
            health = { enable = true, amount = 10 },
    ...
    ['ls_cosmic_kush_joint'] = {
        ...
        level = 1,
        effects = {
            health = { enable = true, amount = 15 },
            armor = { enable = false, amount = 20, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 22500 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 22500 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 22500 }
        }
    },
    ['ls_inferno_blaze_joint'] = {
        usable = true,
        level = 1,
        effects = {
            health = { enable = true, amount = 15 },
            armor = { enable = false, amount = 20, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 25000 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 25000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 25000 }
        }
    },
    ['ls_aqua_bliss_joint'] = {
        usable = true,
        level = 1,
        effects = {
            health = { enable = true, amount = 20 },
            armor = { enable = true, amount = 5, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 27500 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 27500 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 27500 }
        }
    },
    ['ls_shadow_snow_joint'] = {
        usable = true,
        level = 1,
        effects = {
            health = { enable = true, amount = 25 },
            armor = { enable = true, amount = 10, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
    ...
    ['ls_midnight_frost_joint'] = {
        usable = true,
        level = 1,
        effects = {
            health = { enable = true, amount = 45 },
            armor = { enable = true, amount = 5, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 35000 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 35000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 35000 }
        }
    },
    ['ls_crimson_eclipse_joint'] = {
        usable = true,
        level = 1,
        effects = {
            health = { enable = true, amount = 10 },
            armor = { enable = true, amount = 40, max = 100 },
            speed = { enable = false, multiplier = 1.49, duration = 30000 },
            screen = { enable = true, effect = 'stoned_monkeys', duration = 35000 },
            walk = { enable = true, clipset = 'move_m@drunk@a', duration = 35000 },
            shake = { enable = true, name = 'DRUNK_SHAKE', intensity = 2.0, duration = 35000 }
