...
--[[ Pay Conigs ]]
Config.PayPerDelivery = 376 -- How much the player is paid per delivery completed
...
Config.MinPayPerDelivery = 300 -- If Config.RandomPayPerDelivery = true then what is the minimum pay? (If RandomPay false, ignore this)
Config.MaxPayPerDelivery = 500 -- If Config.RandomPayPerDelivery = true then what is the maxmimum pay? (If RandomPay false, ignore this)
