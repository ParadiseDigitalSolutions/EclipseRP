...
Config.DefaultRopeLength = 5	-- Pump rope length
...
-- JerryCan settings
Config.JerryCan = {
	enabled = false,				-- Enable/disable jerry cans purchase
	price = 500,				-- Price to purchase it
	requiredStock = 1,			-- Amount of stock required in gas station to provide a jerry can
...
Config.JobDiscounts = {
	["police"] = 10, 			-- The job name (NOT THE LABEL), and the discount amount in % this job will receive
	["ambulance"] = 10,
}
...
Config.Electric = {
	...
	chargeTypes = {
		fast = {
			...
			time = 0.75,					-- Time in seconds to recharge 0.5% of battery in the vehicle (lower values means faster refuel)
