        ...
        items = {
            {
                ...
                icon = 'address-book',
                type = 'client',
                event = 'ef-phone:client:GiveContactDetails',
                shouldClose = true
            }, {
                id = 'getintrunk',
                title = 'Get In Trunk',
                ...
                icon = 'cannabis',
                type = 'client',
                event = 'lation_weed:client:cornerselling',
                shouldClose = true
            }, {
                id = 'setstash',
                title = 'Set Stash',
    ...
    ["taxi"] = {
        {
            ...
            icon = 'eye-slash',
            type = 'client',
            event = 'angelicxs-CivilianJobs:taxijob:client:toggleMeter',
            shouldClose = false
        }, {
            id = 'togglemouse',
            ...
            type = 'client',
            event = 'angelicxs-CivilianJobs:taxijob:client:enableMeter',
            shouldClose = true
        }, {
            id = 'npc_mission',
            title = 'NPC Mission',
            icon = 'taxi',
            type = 'client',
            event = 'angelicxs-CivilianJobs:taxijob:client:DoTaxiNpc',
            shouldClose = true
        }
    },
    ["tow"] = {
        {
            ...
            icon = 'truck-pickup',
            type = 'client',
            event = 'lation_towing:client:TowVehicle',
            shouldClose = true
        }
    },
    ["mechanic"] = {
